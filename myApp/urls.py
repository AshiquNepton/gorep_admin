...
# urls.py - GoRep (MySQL) URL patterns
# SAS (PostgreSQL) routes are in urls_sas.py and included at the bottom
...
path('api/manage/fix-database/', views.admin_api_fix_database, name='api_manage_fix_database'),
    ...
    # ========== SAS (PostgreSQL) routes — defined in urls_sas.py ==========
    path('', include('myApp.urls_sas')),
]