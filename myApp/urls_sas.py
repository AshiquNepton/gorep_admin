...
from myApp.views_sas import sas_api_next_company_code
...
urlpatterns = [
    ...
    path('manage/backup-pg-sas-database/',  views_sas.sas_backup_pg_sas_database_view,  name='admin_backup_pg_sas_database'),
    path('manage/restore-pg-sas-database/', views_sas.sas_restore_pg_sas_database_view, name='admin_restore_pg_sas_database'),
    ...
    path('api/pg/next-company-code/', sas_api_next_company_code, name='sas_next_company_code'),
    ...
    # ========== SAS (PostgreSQL) Backup / Restore ==========
    path('manage/api/pg/backup-database/',    views_sas.sas_api_backup_database_ssh,   name='admin_api_backup_pg_database'),
    path('manage/api/pg/list-backups/',       views_sas.sas_api_list_backups_ssh,      name='admin_api_list_pg_backups'),
    path('manage/api/pg/download-backup/<str:filename>/', views_sas.sas_api_download_backup, name='admin_api_download_pg_backup'),
    path('manage/api/pg/restore-database/',   views_sas.sas_api_restore_database_ssh,  name='admin_api_restore_pg_database'),
